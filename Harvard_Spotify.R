...
# will downloaded from my GitHub repo (see below the bit.ly-link)
...
# For rerunning the code (bit.ly-link of my GitHub repo):
...
# Test (W = 0.97922, p = 0.08088) based on an alpha-level of 5 %, we can
...
# Overview of the used statistical computing environment and the used 
# operating system:
