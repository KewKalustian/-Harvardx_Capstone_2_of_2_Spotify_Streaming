...
## ----libraries,  echo=T, message=FALSE, warning=FALSE, results = 'hide', paged.print=FALSE----
...
# Please de-comment, to run these lines for web-scraping (warning: takes some time!)
...
# Please de-comment for running the plotting code
...
## ----message=F, warning=F, echo=T, eval = T, paged.print=FALSE, results="hide"----
